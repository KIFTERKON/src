...
alter table tb_prestamo add saldo money-- para agregar esta columna
alter table tb_prestamo add abonos-- para agregar esta columna
...
create table tb_prestamo(
	...
	cantidad money,
	descuento money,
	saldo money, -- para agregar esta columna

...
Connexion con = new Connexion();
	...
	private JScrollPane getPanelTabla()	{		
		...
		try {
			...
			rs = s.executeQuery("select tb_denominaciones.folio as [Folio],"+
					 ...
					 "  tb_denominaciones.efectivo as [Efectivo] "+
					
					"  from tb_denominaciones where status=1");
				...
				if(denominaciones.getFolio() == Integer.parseInt(txtFolio.getText())){
					if(JOptionPane.showConfirmDialog(null, "El registro ya existe, ¿desea cambiarlo?") == 0){
						if(validaCampos()!="") {
							...
							denominaciones.setEfectivo(Float.parseFloat(txtValor.getText()));
	...
	ActionListener buscar = new ActionListener()
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			txtNombre.setText(denominaciones.getNonbre()+"");
			txtValor.setText(denominaciones.getEfectivo()+"");
			System.out.println(denominaciones.getStatus());
	...
	private String validaCampos(){
		String error="";
		if(txtNombre.getText().equals("")) 			error+= "Bono\n";

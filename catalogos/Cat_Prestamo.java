...
public class Cat_Prestamo extends JDialog{
	...
	String status[] = {"Vigente","Pagado","Cancelado Temporal"};
	...
	JButton btnListado = new JButton("Listado De Prestamos");
	...
	public String[][] getMatriz(String NombreCompleto){
		String qry = "select folio,fecha,cantidad from tb_prestamo where nombre_completo='"+NombreCompleto+"' and status='1'";

...
public class Cat_Tipo_Banco extends JFrame{
	...
	public Cat_Tipo_Banco(){
		...
		txtBanco.setDocument(new JTextFieldLimit(100));
			...
			public void mouseClicked(MouseEvent e) {
	        	if(e.getClickCount()==1){
	        		...
	        		int id = Integer.parseInt(modelo.getValueAt(fila,0)+"");
						...
						Obj_Tipo_Banco fuente_sodas = new Obj_Tipo_Banco().buscar(id);
	...
	ActionListener guardar = new ActionListener(){
		public void actionPerformed(ActionEvent e){
			if(txtFolio.getText().equals("")){
				...
				Obj_Tipo_Banco puesto = new Obj_Tipo_Banco().buscar(Integer.parseInt(txtFolio.getText()));
	...
	ActionListener buscar = new ActionListener()
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			Obj_Tipo_Banco puesto = new Obj_Tipo_Banco();
	...
	ActionListener nuevo = new ActionListener(){
		public void actionPerformed(ActionEvent e) {
			Obj_Tipo_Banco puesto = new Obj_Tipo_Banco().buscar_nuevo();
			if(puesto.getFolio() != 0){
				panelLimpiar();
				panelEnabledTrue();

...
public class Obj_Horario_Empleado2 {
	private int folio;
	...
	public Obj_Horario_Empleado2 buscar_tur2(String nombre){
		try{
	...
	public Obj_Horario_Empleado2 buscar_tur2(int folio){
		try{
